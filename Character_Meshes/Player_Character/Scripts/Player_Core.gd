...
@export var tracer_scene: PackedScene = preload("res://assets/Beams/TracerVFX.tscn")
...
@onready var gun_mesh = $"Visuals/Samsara Rig/Skeleton3D/Gun"
...
@onready var muzzle_flash11 = $"Visuals/Samsara Rig/Skeleton3D/BoneAttachment3D/MuzzleFlash"
@onready var muzzle_flash22 = $"Visuals/Samsara Rig/Skeleton3D/BoneAttachment3D/MuzzleFlash2"
@onready var muzzle_flash33 = $"Visuals/Samsara Rig/Skeleton3D/BoneAttachment3D/WideFlash"
@onready var muzzle_flash44 = $"Visuals/Samsara Rig/Skeleton3D/BoneAttachment3D/WideFlash2"
...
func _physics_process(delta):
	...
	if muzzleType == MuzzleType.PRECISION:
		...
		muzzle_flash = muzzle_flash11
		muzzle_flash2 = muzzle_flash22
	elif muzzleType == MuzzleType.WIDE:
		muzzle.position.z = 3.5
		muzzle_flash = muzzle_flash33
		muzzle_flash2 = muzzle_flash44
